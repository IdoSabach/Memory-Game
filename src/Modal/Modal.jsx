  ...
  return (
    <>
      ...
      <div className="modal rounded-xl flex flex-col" style={MODAL_STYLES}>
        ...
        <button onClick={handleClose} className="btn text-center text-2xl bg-black rounded-xl text-white p-2 mt-2 lg:text-4xl lg:p-4 lg:mt-5 lg:mb-1">Play Again?</button>
      </div>
    </>
  );
}
