...
export default function Main() {
  ...
  return (
    <div className="main justify-items-center mr-2 ml-2 mt-8 mb-8 p-2 rounded-xl lg:m-24 bg-transparent border border-black backdrop-blur-md bg-opacity-50 inset-0">
      <header className="head flex justify-around text-xl font-bold mt-4 mb-4 bg-transparent">
        <div className="curr bg-transparent text-sm lg:text-xl">Current Score:{currScore} </div>
        <div className="best bg-transparent text-sm lg:text-xl">Best Score: {bestScore} </div>
      </header>
